...
class _CheckOutState extends State<CheckOut> {
  ...
  Widget build(BuildContext context) {
    ...
    final paymentMethodList = Provider.of<List<PaymentMethodModel>>(context);
        ...
        children: [
          Container(
            ...
            child: ListView(
              ...
              children: [
                _buildShippingInformation(userInfo),
                _buildPaymentMehtod(userInfo, _checkoutviewmodel),
              ],
            ),
          ),
  ...
  Widget _buildShippingInformation(UserModel userInfo) {
    return Padding(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                userInfo.unitAndBuilding.isEmpty &&
                userInfo.estate.isEmpty &&
                userInfo.district.isEmpty
                ? '點擊設定運送地址 \n'
                : '${userInfo.recipientName} \n${userInfo.unitAndBuilding} \n${userInfo.estate} ${userInfo.district}',
  ...
  Widget _buildPaymentMehtod(UserModel userInfo, CheckoutViewModel checkoutViewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        //  Title
        ...
        //  QR Code
        GestureDetector(
          onTap: () => checkoutViewModel.downloadQRCode(_paymentMethodList[_initTagIndex]),
          child: SizedBox(
            height: 250,
        ...
        Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () => checkoutViewModel.uploadpaymentButtonOnClick(context, userInfo, widget.orderModel, _paymentMethodList[_initTagIndex].methodName),
              child: const Text(
                '上載已支付証明',
              ),
            )),
